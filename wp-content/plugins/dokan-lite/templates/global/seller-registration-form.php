...
<div class="show_if_seller" style="<?php echo esc_attr( $role_style ); ?>">
    ...
    <div class="split-row form-row-wide">
        <p class="form-row form-group">
            <label for="first-name"><?php esc_html_e( 'Prénom', 'dokan-lite' ); ?> <span class="required">*</span></label>
        ...
        <p class="form-row form-group">
            <label for="last-name"><?php esc_html_e( 'Nom', 'dokan-lite' ); ?> <span class="required">*</span></label>
    ...
    <p class="form-row form-group form-row-wide">
        <label for="company-name"><?php esc_html_e( 'Boutique', 'dokan-lite' ); ?> <span class="required">*</span></label>
    ...
    <p class="form-row form-group form-row-wide">
        <label for="seller-url" class="pull-left"><?php esc_html_e( 'URL Boutique', 'dokan-lite' ); ?> <span class="required">*</span></label>
    ...
    <p class="form-row form-group form-row-wide">
        <label for="shop-phone"><?php esc_html_e( 'Numéro de téléphone', 'dokan-lite' ); ?><span class="required">*</span></label>
        ...
        <p class="form-row form-group form-row-wide">
            ...
            <label style="display: inline" for="tc_agree">
                ...
                /* translators: %1$s: opening anchor tag with link, %2$s: an ampersand %3$s: closing anchor tag */
                    __( "J'ai lu et j'accepte les termes et conditions.", 'dokan-lite' ),
...
<p class="form-row form-group user-role vendor-customer-registration">
    ...
    <label class="radio">
        ...
        <?php esc_html_e( 'Je suis un client', 'dokan-lite' ); ?>
    </label>
    <br/>
    <label class="radio">
        <input type="radio" name="role" value="seller"<?php checked( $role, 'seller' ); ?>  class="dokan-role-seller">
        <?php esc_html_e( 'Je suis un vendeur', 'dokan-lite' ); ?>
    </label>
