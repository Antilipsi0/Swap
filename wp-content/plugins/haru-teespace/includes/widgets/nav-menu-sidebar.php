...
if ( ! class_exists( 'Haru_TeeSpace_Nav_Menu_Sidebar_Widget' ) ) {
	class Haru_TeeSpace_Nav_Menu_Sidebar_Widget extends Widget_Base {
		...
		protected function render() {
			...
			$this->add_render_attribute( 'haru-nav-menu-sidebar-wrap', 'class', 'sidebar-position sidebar-position--' . $settings['sidebar_position'] . ' sidebar-position--tablet-' . $settings['sidebar_position_tablet'] . 'sidebar-position--mobile-' . $settings['sidebar_position'] );
