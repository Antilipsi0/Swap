...
function wc_get_account_menu_items() {
	...
	$items = array(
		...
		'downloads'       => __( 'Factures', 'woocommerce' ),
		'edit-address'    => _n( 'Adresse', 'Adresses', ( 1 + (int) wc_shipping_enabled() ), 'woocommerce' ),
		'payment-methods' => __( 'Moyens de paiements', 'woocommerce' ),
