...
<?php if ( 'yes' == $product_new ) : ?>
    ...
    <span class="product-label__item product-label__item--onnew"><?php echo esc_html__( 'Nouveau', 'teespace' ) ?></span>

<?php endif; ?>

<?php if ( 'yes' == $product_hot ) : ?>

    <span class="product-label__item product-label__item--onhot"><?php echo esc_html__( 'Chaud', 'teespace' ) ?></span>

<?php endif; ?>

<?php if ( ! $product->is_in_stock() ) : ?>

    <span class="product-label__item product-label__item--onsold"><?php echo esc_html__( 'Promo', 'teespace' ) ?></span>
