...
<div class="product_meta">
    ...
    <?php if ( wc_product_sku_enabled() && ( $product->get_sku() || $product->is_type( 'variable' ) ) ) : ?>
        ...
        <span class="sku_wrapper">
        	<span class="label"><?php echo esc_html__( 'Quantité :', 'teespace' ); ?></span>
        	<span class="sku"><?php echo do_shortcode( ( $sku = $product->get_sku() ) ? $sku : esc_html__( 'N/A', 'teespace' ) ); ?></span>
        </span>

    <?php endif; ?>

    <?php echo wc_get_product_category_list( $product->get_id(), ', ', '<span class="posted_in">' . _n( '<span class="label">Catégorie :</span>', '<span class="label">Catégories :</span>', count( $product->get_category_ids() ), 'teespace' ) . ' ', '</span>' ); ?>
