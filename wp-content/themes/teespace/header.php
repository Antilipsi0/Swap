...
<html <?php language_attributes(); ?>>
    ...
    <head>
		...
		<link rel="stylesheet" href="https://use.typekit.net/swc5hut.css">
        ...
        <!-- Google tag (gtag.js) -->
        <script async src="https://www.googletagmanager.com/gtag/js?id=G-3ZB1XC1327"></script>
        <script>
        window.dataLayer = window.dataLayer || [];
        function gtag(){dataLayer.push(arguments);}
        gtag('js', new Date());

        gtag('config', 'G-3ZB1XC1327');
        </script>
    </head>
    <!-- Close Head -->
    <body <?php body_class(); ?>>
