<div id="dokan-seller-listing-wrap" class="grid-view">
    <div class="seller-listing-content">
                                ...
                                <div class="store-data-container">
                                    <?php if ( 'on' === $show_store_open_close && 'yes' === $dokan_store_time_enabled ) : ?>
                                        <?php if ( dokan_is_store_open( $seller->ID ) ) { ?>
                                            <span class="dokan-store-is-open-close-status dokan-store-is-open-status" title="<?php esc_attr_e( 'Store is Open', 'teespace' );?>"><?php esc_html_e( 'Ouvrir', 'teespace' ); ?></span>
                                        <?php } else { ?>
                                            <span class="dokan-store-is-open-close-status dokan-store-is-closed-status" title="<?php esc_attr_e( 'Store is Closed', 'teespace' );?>"><?php esc_html_e( 'Fermer', 'teespace' ); ?></span>
                                        <?php } ?>
                                    <?php endif ?>
                                    ...
                                    <div class="store-data <?php echo esc_attr( $store_open_is_on ); ?>">
                                        ...
                                        <?php if ( ! dokan_is_vendor_info_hidden( 'Adresse' ) && $store_address ): ?>
                                            <?php
                                                $allowed_tags = array(
                                                    'span' => array(
                                                        'class' => array(),
                                        ...
                                        <div class="store-action">
                                            <a href="<?php echo esc_url( $store_url ); ?>" class="haru-button haru-button--text-black" title="<?php esc_attr_e( 'Visiter la boutique', 'teespace' );?>">
                                            </a>
                                        </div>
        ...
        <?php else:  ?>
            <p class="dokan-error"><?php esc_html_e( 'Aucun vendeur trouvé !', 'teespace' ); ?></p>
        <?php endif; ?>
    </div>
</div>
