...
$rocket_cookie_hash = '2db44b5cd6eb632813601c5141f3b78c';
$rocket_logged_in_cookie = 'wordpress_logged_in_2db44b5cd6eb632813601c5141f3b78c';
$rocket_cache_mobile_files_tablet = 'desktop';
$rocket_secret_cache_key = '63a969708a4dc026791212';
$rocket_cache_mobile = 1;
$rocket_do_caching_mobile_files = 0;
$rocket_cache_webp = 0;
$rocket_cache_ssl = 1;
$rocket_cache_reject_uri = '/swap(/(.+/)?feed/?.+/?|/(?:.+/)?embed/|/commander/(.*)|/panier/|/mon-compte/(.*)|/wc-api/v(.*)|/(index\.php/)?wp\-json(/.*|$))';
